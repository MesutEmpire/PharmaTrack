const { addData,getSaleData,updateData,deleteData ,getUserData,getProductData,getPurchaseOrderData,getLowInventoryData,getSupplierData,getExpiringProductData,getAddSuppliers} = require("../controller/productController");
...
router.get("/expiring_product/:pharmacy",requireUserAuth, getExpiringProductData);
