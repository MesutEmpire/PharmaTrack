...
module.exports = { addData, getSaleData, updateData, deleteData,getUserData,getProductData,getPurchaseOrderData,getLowInventoryData,getSupplierData,getExpiringProductData,getAddSuppliers };
