...
export const features = [
  {
    id:1,
    type:"Reporting",
    title:"Stay on top of things with always\n" +
...
export const testimonials = [
      {
        id:1,
        comment:'TaxPal is so easy to use I\n' +
      ...
      {
        id:2,
        comment:'I’m trying to get a hold of someone in support, I’m in a lot of trouble right now and they are saying it has something to do with my books. Please get back to me right away.',
        name:'Amy Hahn',
  ...
  {
    id:3,
    comment:'The best part about TaxPal is\n' +
  ...
  {
    id:5,
    comment:'  There are so many things I had\n' +
  ...
  {
    id:6,
    comment:' I used to have to remit tax to the EU and with TaxPal I somehow don’t have to do that anymore. Nervous to travel there now though.',
    name:'    Peter Renolds',
  ...
  {
    id:7,
    comment:' This is the fourth email I’ve\n' +
...
export const subscriptions = [
  {
    ...
    color:'bg-slate-900',
    price:'$10',
    description:'Good for anyone who is self-employed and just getting\n' +
        'started.',
    packages:[
'Send 10 quotes and invoices','Connect up to 2 bank accounts','Track up to 15 expenses per month','Manual payroll support','Export up to 3 reports'
    ]
