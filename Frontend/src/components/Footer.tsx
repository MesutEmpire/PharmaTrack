        ...
        <footer className="bg-slate-50">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <div className="flex gap-x-6"><a className="group" aria-label="TaxPal on Twitter"
                    ...
                    </a><a className="group" aria-label="TaxPal on GitHub" href="https://github.com">
                        <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
                            <path
                    ...
                    <p className="mt-6 text-sm text-slate-500 sm:mt-0">Copyright © 2023 PharmaTrack. All
