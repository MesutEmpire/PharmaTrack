...
import {setProductsForm, selectErrorPostProduct,setErrorPostProduct,selectProductFormData} from "../stores/productSlice";
import {selectSupplierAddProduct, setAddSuppplierProduct,setErrorPostSupplier} from '../stores/supplierSlice'
                            ...
                            <div className="grid">
                                ...
                                >
                                    ...
                                    <form    onSubmit={(event: FormEvent) => postLoginData(event)}
                                             onChange={(event: any) =>
                                                 dispatch(setProductsForm({ [event.target.name]: event.target.value }))
                                             } >
                                        ...
                                        <div className="relative mb-6">
                                            ...
                                            >
                                                {suppliers.map((supplier:any,key:number)=>{
                                                    return (
                                                        <option key={key} value={supplier.supplier_id} className="input_design">{supplier.supplier_name}</option>
                                                    )
                                                })}
